...
<!-- engineering-method:backlog {"schema_version":1,"id":"EM-008","title":"Add source-linked OpenCode skill integration","status":"in_progress","priority":"P1","parent_id":null,"depends_on":[],"notes":"User authorized implementation and local installation. Preserve shared skills and existing provider settings; verify native discovery and bounded skill use.","updated_at":"2026-09-11T14:06:32Z"} -->
- 🔄 `EM-008` **P1** Add source-linked OpenCode skill integration
  - Notes: User authorized implementation and local installation. Preserve shared skills and existing provider settings; verify native discovery and bounded skill use.

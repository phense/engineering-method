...
<!-- engineering-method:backlog {"schema_version":1,"id":"EM-007","title":"Publish stable version 0.1.0 and update public documentation","status":"in_progress","priority":"P2","parent_id":null,"depends_on":["EM-005"],"notes":"Explicitly authorized stable release. Reuse accepted unchanged implementation evidence; run fresh local packaging/install checks and verify the tag, release and downloaded assets. No issue migration.","updated_at":"2026-09-05T19:22:14Z"} -->
- 🔄 `EM-007` **P2** Publish stable version 0.1.0 and update public documentation
  - Depends on: `EM-005`
  - Notes: Explicitly authorized stable release. Reuse accepted unchanged implementation evidence; run fresh local packaging/install checks and verify the tag, release and downloaded assets. No issue migration.

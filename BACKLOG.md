...
<!-- engineering-method:backlog {"schema_version":1,"id":"EM-009","title":"Publish OpenCode integration as patch release 0.1.1","status":"in_progress","priority":"P1","parent_id":null,"depends_on":[],"notes":"User authorized GitHub push and small version bump; preserve historical acceptance evidence.","updated_at":"2026-09-11T15:09:46Z"} -->
- 🔄 `EM-009` **P1** Publish OpenCode integration as patch release 0.1.1
  - Notes: User authorized GitHub push and small version bump; preserve historical acceptance evidence.

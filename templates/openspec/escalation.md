# OpenSpec Escalation: <change name>
...
- Boundary crossed: <new subsystem, architecture, risky migration, coupled components, or material uncertainty>
- Evidence: <repository paths, contracts, tests, or design findings>
- Why the delta lifecycle cannot safely contain it: <reason>
